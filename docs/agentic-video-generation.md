<a id="agentic-video-generation"></a>

# 智能体视频生成

介绍创作规划、生成工具调用、候选检查和局部返工的系统设计。

**前置知识：** 文生视频、多镜头生成。

**使用步骤：** 定义创作要求和预算 → 组织镜头、资产与工具接口 → 比较固定流程、候选筛选与反馈修复的质量和成本。


**基本定义：Agentic Video Generation 把视频生成器作为工具，由智能体把创作目标拆成可执行计划，并根据实际产物选择、修改或重新生成，直到满足要求或用完预算。**
...
手册结构修订：2026-09-20。原资料覆盖日期：见具体条目。动态资源状态以条目日期和官方入口为准；未标注本仓库复现的实验数字均按其引用来源理解。
