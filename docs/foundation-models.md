...
<a id="system-attribution-matrix"></a>

下表与能力地图中的[能力归因矩阵](foundation-model-capabilities.md#capability-attribution-matrix)配套使用：先确认 C1–C9 中声称的能力，再确定证据究竟来自单 checkpoint、模型家族还是完整产品系统。
